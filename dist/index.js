...
// lib/cache/ActionRecorder.ts
var ActionRecorder = class _ActionRecorder extends BaseCache {
  constructor(logger, cacheDir, cacheFile) {
    logger({
      category: "action_recorder",
      message: "initializing action recorder at " + cacheDir + " with file " + cacheFile,
      level: 1
    });
  ...
  getActionStep(_0) {
    return __async(this, arguments, function* ({
      ...
      const data = yield __superGet(_ActionRecorder.prototype, this, "get").call(this, { url, action, previousSelectors }, requestId);
      if (!data) {
        return null;
      }
      return data;
  ...
  removeActionStep(cacheHashObj) {
    return __async(this, null, function* () {
      yield __superGet(_ActionRecorder.prototype, this, "delete").call(this, cacheHashObj);
    });
  }
  /**
   * Clears all actions for a specific trajectory.
  ...
  clearAction(requestId) {
    return __async(this, null, function* () {
      yield __superGet(_ActionRecorder.prototype, this, "deleteCacheForRequestId").call(this, requestId);
      this.logger({
        category: "action_recorder",
        message: "cleared action for ID",
        level: 1,
  ...
  resetCache() {
    return __async(this, null, function* () {
      yield __superGet(_ActionRecorder.prototype, this, "resetCache").call(this);
      this.logger({
        category: "action_recorder",
...
function buildCodeConverterSystemPrompt() {
  return {
    role: "system",
...
function buildCodeConverterUserPrompt(playwrightCode, targetFramework) {
  return {
    role: "user",
...
function convertPlaywrightCodeToFramework(playwrightCode, targetFramework, llmClient, requestId, logger) {
  return __async(this, null, function* () {
    const response = yield llmClient.createChatCompletion({
      options: {
        messages: [
...
// lib/handlers/testCodeGenerator.ts
var TestCodeGenerator = class {
  constructor({
    actionRecorder,
    logger,
    llmProvider
  ...
  _getRecordedActions() {
    ...
    return this.actionRecorder.getAllActions().then(
      (actions) => actions.sort((a, b) => (a.timestamp || 0) - (b.timestamp || 0))
    );
  }
  _convertXPathToPlaywrightSelector(xpath) {
  ...
  _buildPythonPlaywrightCode() {
    return __async(this, null, function* () {
      var _a;
      const url = yield this._getUrlFromActions();
      const codeLines = [
      ...
      const sortedActions = yield this._getRecordedActions();
      for (const action of sortedActions) {
        const data = action.data;
        const command = data.playwrightCommand;
        const xpath = (_a = data.xpaths) == null ? void 0 : _a[0];
        if (!xpath) {
          continue;
        }
  ...
  _buildTypescriptPlaywrightCode() {
    return __async(this, null, function* () {
      var _a;
      const url = yield this._getUrlFromActions();
      const codeLines = [
  ...
  generateCode(language, testFramework) {
    return __async(this, null, function* () {
      const getCodeForLanguage = (language2) => __async(this, null, function* () {
        switch (language2) {
          case "typescript":
          ...
          default:
            throw new Error(`Unsupported language: ${language2}`);
        }
      });
      if (testFramework !== "playwright") {
        const playwrightCode = yield getCodeForLanguage(language);
        return yield convertPlaywrightCodeToFramework(
          playwrightCode,
          testFramework,
      ...
      return yield getCodeForLanguage(language);
    });
  }
};
...
var StagehandActHandler = class {
  constructor({
    ...
    this.actionRecorder = enableRecording ? new ActionRecorder(this.logger) : void 0;
    this.actions = {};
  ...
  _recordActionIfEnabled(_0) {
    return __async(this, arguments, function* ({
      ...
      yield (_a = this.actionRecorder) == null ? void 0 : _a.addActionStep({
        url,
        action,
        previousSelectors,
        playwrightCommand,
...
`;
  ...
  dumpRecordedActionsCode(options) {
    return __async(this, null, function* () {
      ...
      const code = yield generator.generateCode(
        options.language,
...
var StagehandObserveHandler = class {
  ...
  observe(_0) {
    return __async(this, arguments, function* ({
      ...
      const evalResult = yield this.stagehand.page.evaluate(() => __async(this, null, function* () {
        const result = yield window.processAllOfDom();
        return result;
      }));
  ...
  observe(options) {
    return __async(this, null, function* () {
      ...
      this.stagehand.log({
        ...
        auxiliary: {
          ...
          useAccessibilityTree: {
            value: (options == null ? void 0 : options.useAccessibilityTree) ? "true" : "false",
            type: "boolean"
          }
        }
      });
      return this.observeHandler.observe({
        ...
        useAccessibilityTree: (_c = options == null ? void 0 : options.useAccessibilityTree) != null ? _c : false
      }).catch((e) => {
        this.stagehand.log({
          category: "observe",
...
var Stagehand = class {
  constructor({
    ...
    this.enableRecording = enableRecording != null ? enableRecording : process.env.ENABLE_RECORDING && process.env.ENABLE_RECORDING === "true";
  ...
  dumpRecordedActionsCode(options) {
    return __async(this, null, function* () {
      return yield this.stagehandPage.dumpRecordedActionsCode(options);
    });
  }
};
