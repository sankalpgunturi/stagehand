...
export declare function convertPlaywrightCodeToFramework(playwrightCode: string, targetFramework: string, llmClient: LLMClient, requestId: string, logger: (message: LogLine) => void): Promise<string>;
