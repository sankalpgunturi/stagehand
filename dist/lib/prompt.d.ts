...
export declare function buildCodeConverterSystemPrompt(): ChatMessage;
export declare function buildCodeConverterUserPrompt(playwrightCode: string, targetFramework: string): ChatMessage;
