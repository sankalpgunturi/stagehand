...
interface DumpRecordedActionsCodeOptions {
    language: "typescript" | "python";
    testFramework: "playwright" | "puppeteer" | "cypress";
}
interface DumpRecordedActionsCodeResult {
    code: string;
}
...
declare class Stagehand {
    ...
    constructor({ env, apiKey, projectId, verbose, debugDom, llmProvider, llmClient, headless, logger, browserbaseSessionCreateParams, domSettleTimeoutMs, enableCaching, enableRecording, browserbaseSessionID, modelName, modelClientOptions, systemPrompt, }?: ConstructorParams);
...
export { type ActOptions, type ActResult, AnnotatedScreenshotText, type AnthropicJsonSchemaObject, type AvailableModel, AvailableModelSchema, type Browser, type BrowserContext, type BrowserResult, type ChatCompletionOptions, type ChatMessage, type ChatMessageContent, type ChatMessageImageContent, type ChatMessageTextContent, type ClientOptions, type ConstructorParams, type CreateChatCompletionOptions, type DumpRecordedActionsCodeOptions, type DumpRecordedActionsCodeResult, type ExtractOptions, type ExtractResult, type GotoOptions, type InitFromPageOptions, type InitFromPageResult, type InitOptions, type InitResult, LLMClient, type LLMResponse, type LogLine, type ModelProvider, type ObserveOptions, type ObserveResult, type Page, PlaywrightCommandException, PlaywrightCommandMethodNotSupportedException, Stagehand, modelsWithVision };
